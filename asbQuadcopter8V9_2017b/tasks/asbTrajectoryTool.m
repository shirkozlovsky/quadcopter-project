...
if ~isempty(wpGUI)
    ...
    errordlg(getString(message('aeroblks:asbquadcopter:wpListError')),...
        getString(message('aeroblks:asbquadcopter:ListErrorTitle')));
end
...
if ~isempty(wpList)
    ...
    errordlg(getString(message('aeroblks:asbquadcopter:wpEditListError')),...
        getString(message('aeroblks:asbquadcopter:ListErrorTitle')));
end
...
if ~isempty(nfzGUI)
    ...
    errordlg(getString(message('aeroblks:asbquadcopter:nfzListError')),...
        getString(message('aeroblks:asbquadcopter:ListErrorTitle')));
end
...
if ~isempty(nfzList)
    ...
    errordlg(getString(message('aeroblks:asbquadcopter:nfzEditListError')),...
        getString(message('aeroblks:asbquadcopter:ListErrorTitle')));
end
...
if length(wpGUI)<2
    errordlg(getString(message('aeroblks:asbquadcopter:wpNumError')),...
        getString(message('aeroblks:asbquadcopter:ListErrorTitle')));
else    
    ...
    if getfield(vr.appdependent, 'fullinstall') && ...
            license('test','virtual_reality_toolbox')  %#ok<GFLD>
...
buttonDlg = questdlg(getString(message('aeroblks:asbquadcopter:defaultData')),...
    getString(message('aeroblks:asbquadcopter:defaultDataTitle')));
...
if ~isempty(wp)
    ...
    errordlg(getString(message('aeroblks:asbquadcopter:saveWpError')),...
        getString(message('aeroblks:asbquadcopter:ListErrorTitle')));
...
buttonDlg = questdlg(getString(message('aeroblks:asbquadcopter:savedData')),...
    getString(message('aeroblks:asbquadcopter:defaultDataTitle')));
