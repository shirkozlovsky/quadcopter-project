...
this.def["flightController_MdlrefDW"] = {file: "flightController_c.html",line:167,type:"var"};
this.def["flightController_DW"] = {file: "flightController_c.html",line:170,type:"var"};
this.def["flightController_Init"] = {file: "flightController_c.html",line:173,type:"fcn"};
this.def["flightController_run"] = {file: "flightController_c.html",line:193,type:"fcn"};
this.def["flightController_g_initialize"] = {file: "flightController_c.html",line:449,type:"fcn"};
this.def["DW_flightController_f_T"] = {file: "flightController_h.html",line:37,type:"type"};
this.def["MdlrefDW_flightController_T"] = {file: "flightController_h.html",line:146,type:"type"};
this.def["CommandBus"] = {file: "flightController_types_h.html",line:32,type:"type"};
this.def["statesEstim_t"] = {file: "flightController_types_h.html",line:52,type:"type"};
this.def["struct_eAf0NJvzCY9HYTXF7bLNgB"] = {file: "flightController_types_h.html",line:65,type:"type"};
this.def["struct_XRMsui9C07VjBvdq1msujB"] = {file: "flightController_types_h.html",line:75,type:"type"};
this.def["struct_hxsmtt0xTZOLDNa2Rz7GAF"] = {file: "flightController_types_h.html",line:84,type:"type"};
this.def["struct_IZWOW0zYvpphl7qLgSfN7E"] = {file: "flightController_types_h.html",line:94,type:"type"};
this.def["struct_q6UUpnZ4gTjFvULFx6Rxa"] = {file: "flightController_types_h.html",line:110,type:"type"};
this.def["struct_OMRgDnJcZuQneKEj9vdTyD"] = {file: "flightController_types_h.html",line:140,type:"type"};
this.def["struct_p3FXZIgqtjF2uqDpmYjb6C"] = {file: "flightController_types_h.html",line:152,type:"type"};
this.def["struct_OSJpyIZcrpXqReVWwh9iuG"] = {file: "flightController_types_h.html",line:165,type:"type"};
this.def["P_flightController_T"] = {file: "flightController_types_h.html",line:170,type:"type"};
this.def["RT_MODEL_flightController_T"] = {file: "flightController_types_h.html",line:173,type:"type"};
