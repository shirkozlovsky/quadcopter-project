...
## Generated on : Wed Nov 28 09:56:37 2018
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/profiles/users/sasson/Desktop/shir/asbQuadcopter31
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = flightControlSystem_ref.rsp
...
INCLUDES_BUILDINFO = -I./referenced_model_includes -I$(START_DIR) -I$(START_DIR)/flightControlSystem_ert_rtw -I$(START_DIR)/controller -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/include
...
DEFINES_ = -DMODEL=flightControlSystem -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DDELOS -DDELOS_EDU -DEXTMODE_DISABLETESTING -DEXTMODE_STATIC_SIZE=16384 -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DPARROT_LINUX_COMM -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMATFILE_LOGGING=1 -DSTOP_TIME=40 -DROLLINGSPIDER=1
...
DEFINES_SKIPFORSIL = -DDELOS -DDELOS_EDU -DEXTMODE_DISABLETESTING -DEXTMODE_STATIC_SIZE=16384 -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DPARROT_LINUX_COMM -DSTACK_SIZE=64 -DRT -DMATFILE_LOGGING=1 -DSTOP_TIME=40 -DROLLINGSPIDER=1
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/flightControlSystem_ert_rtw/flightControlSystem.c $(START_DIR)/flightControlSystem_ert_rtw/flightControlSystem_data.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_control.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_of.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_vis.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_vis_helpers.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/controlCommand.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/mw_extrathreads.c
...
OBJS = rt_logging.o flightControlSystem.o flightControlSystem_data.o rsedu_control.o rsedu_of.o rsedu_vis.o rsedu_vis_helpers.o controlCommand.o mw_extrathreads.o
...
MODELREF_LIBS = ./flightController_rtwlib.a ./stateEstimator_rtwlib.a
...
rsedu_control.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_control.c
	$(CC) $(CFLAGS) -o $@ $<


rsedu_of.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_of.c
	$(CC) $(CFLAGS) -o $@ $<


rsedu_vis.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_vis.c
	$(CC) $(CFLAGS) -o $@ $<


rsedu_vis_helpers.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/rsedu_vis_helpers.c
	$(CC) $(CFLAGS) -o $@ $<


controlCommand.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/controlCommand.c
	$(CC) $(CFLAGS) -o $@ $<


mw_extrathreads.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/parrot/src/mw_extrathreads.c
	$(CC) $(CFLAGS) -o $@ $<
